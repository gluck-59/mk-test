<?php /* Smarty version 2.6.20, created on 2018-07-02 20:31:38
         compiled from /home/motokofr/public_html/modules/blockcart/blockcart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 15, false),array('function', 'convertPrice', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 38, false),array('function', 't', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 50, false),array('function', 'displayWtPrice', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 52, false),array('modifier', 'escape', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 50, false),array('modifier', 'intval', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 65, false),array('modifier', 'count', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 82, false),array('modifier', 'truncate', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 86, false),array('modifier', 'replace', '/home/motokofr/public_html/modules/blockcart/blockcart.tpl', 107, false),)), $this); ?>
﻿
<?php if (@site_version == 'full'): ?>

<?php echo '<script>    $.ajaxSetup({ cache: false }); </script>'; ?>
...
<?php endif; ?></span>
			...
			<span class="ajax_cart_product_txt_d hidden">ништяков на</span>
...
"><?php echo smartyTruncate(array('text' => $this->_tpl_vars['product']['name'],'length' => '50','encode' => 'true'), $this);?>
</a>
...
<br><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['discount']['description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 55, '...') : smarty_modifier_truncate($_tmp, 55, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</td>
...
<?php endif; ?></span>
	...
	<acronym title="С 1 июля 2018 посылки стоимостью свыше <?php echo $this->_tpl_vars['porog']; ?>
 Евро облагаются пошлиной. Внимательно!"><?php echo smartyTranslate(array('s' => 'Import tax!','mod' => 'blockcart'), $this);?>
</acronym>
	</span>
		<?php endif; ?>
...
order.php" class="ebutton green" title="<?php echo smartyTranslate(array('s' => 'Cart','mod' => 'blockcart'), $this);?>
"><?php echo smartyTranslate(array('s' => 'Check out','mod' => 'blockcart'), $this);?>
</a><br>
				<?php else: ?>
                <a href="#" onclick="javascript:toastr.error('Твой кофр пока пуст.<br>Положи в него что-нибудь.');" class="ebutton green" title="<?php echo smartyTranslate(array('s' => 'Cart','mod' => 'blockcart'), $this);?>
"><?php echo smartyTranslate(array('s' => 'Check out','mod' => 'blockcart'), $this);?>
</a><br>
                <?php endif; ?>
							</p>
