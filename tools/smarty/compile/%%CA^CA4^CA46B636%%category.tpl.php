<?php /* Smarty version 2.6.20, created on 2016-11-20 12:44:22
         compiled from /home/motokofr/public_html/themes/Earth/category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/home/motokofr/public_html/themes/Earth/category.tpl', 5, false),array('function', 'l', '/home/motokofr/public_html/themes/Earth/category.tpl', 26, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['category']->id && $this->_tpl_vars['category']->active): ?>
	<h2 class="category_title"><?php echo ((is_array($_tmp=$this->_tpl_vars['category']->name)) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</h2>
	...
	<?php else: ?>
        ...
        <?php if (@site_version == 'full'): ?>
    		...
    		<?php if ($this->_tpl_vars['category']->id_image): ?>
    			<center><img src="<?php echo $this->_tpl_vars['link']->getCatImageLink($this->_tpl_vars['category']->link_rewrite,$this->_tpl_vars['category']->id_image,'category'); ?>
...
" id="categoryImage" /></center>
	...
	<div id="subcategories">
		<h3 style="text-shadow:none; color:#374853;; margin-left:22px;"><?php echo smartyTranslate(array('s' => 'Subcategories'), $this);?>
</h3>
