...
class Blockshopbyprice extends Module
{
       ...
       function __construct()
 	{
		...
		$this->confirmUninstall = $this->l('Uninstalling this will delete any price ranges you set up in this mode. It might be worth making a note of them before uninstalling. Pressing OK will uninstall the module or pressing Cancel will leave it installed');
		$this->version = '1.2';
        parent::__construct();
 	}
        ...
        function createtbl()
	{
  	...
  	public function getContent()
		...
		$this->_html .=
                      ...
                      <hr style="height:1px; dotted #ccc" width="400" align="left" />
                       <label for="maxprice" >'.$this->l('Enter Minimum Price').'</label>
           ...
           if (isset($_POST['Delete']) && ($_POST['moderate']))
             {
                ...
                $this->_html .= $this->displayConfirmation(
                                        $this->l('The selected shop price range has been deleted
                                        ') );
               }
               ...
               if (!is_numeric ($minprice))
                   {
                       $this->_html .= $this->displayError(
                                            $this->l('Please Set a Minimum Price - it must be a number e.g 0 and above
                                            ') );
                       return false;
                   }
               else
