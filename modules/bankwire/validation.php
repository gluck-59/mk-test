...
$currency = new Currency(intval(isset($_POST['currency_payement']) ? $_POST['currency_payement'] : 1));
...
$bankwire->validateOrder($cart->id, _PS_OS_BANKWIRE_, $total, $bankwire->displayName, NULL, $mailVars, 1);
echo $total;
