...
$products = Product::getNewProducts(3, 0, 1000 , false, $orderBy, $orderWay);
...
<?php
	foreach ($products AS $product)
	{
		...
		echo "\t\t\t<description>&lt;img src=&quot;"._PS_BASE_URL_.__PS_BASE_URI__."img/p/".$image[0]['id_product']."-".$image[0]['id_image']."-medium.jpg&quot; title=&quot;".$product['name']."&quot; alt=&quot;thumb&quot; /&gt;
		<![CDATA[".$product['description']."]]></description>\n";
