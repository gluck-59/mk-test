<script type="text/javascript" src="{$pathMDEvo}js/jquery.hoverIntent.minified.js"></script>
<script type="text/javascript" src="{$pathMDEvo}js/navmegadrownEvo.js"></script>
<link href="{$pathMDEvo}css/navmegadrownEvo.css" rel="stylesheet" type="text/css" />
<style type="text/css">
	{literal}
	.container {
