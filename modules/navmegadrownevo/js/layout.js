(function($){
	var initLayout = function() {
		...
		$('#colorpickerHolder2>div, #colorpickerHolder5>div, #colorpickerHolder3>div, #colorpickerHolder5>div, #colorpickerHolder6>div, #colorpickerHolder7>div, #colorpickerHolder8>div, #colorpickerHolder4>div, #colorpickerHolder9>div, #colorpickerHolder10>div, #colorpickerHolder11>div, #colorpickerHolder12>div, #colorpickerHolder13>div').css('position', 'absolute');
		var widt = false;
		...
		$('#colorpickerField1, #colorpickerField2, #colorpickerField3, #colorpickerField4, #colorpickerField5, #colorpickerField6, #colorpickerField7, #colorpickerField8, #colorpickerField9, #colorpickerField10, #colorpickerField11, #colorpickerField12, #colorpickerField13').ColorPicker({
			onSubmit: function(hsb, hex, rgb, el) {
				$(el).val(hex);
				$(el).ColorPickerHide();
			},
