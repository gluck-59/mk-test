...
//		$currency = new Currency(2); //intval($id_currency=2)
		$iso_currency = $currency->iso_code;
		$token = strval($cookie->paypal_token);
//		$total = number_format(floatval($cart->getOrderTotal(true, 3)), 2, '.', ''); //оригинал
		$total = number_format(floatval(Tools::convertPrice($cart->getOrderTotal(true, 3),$currency)), 2, '.', '');
