...
$("#getContent").css('height','1000px');
$("#getContent").css('padding-top','15px');
	$('html, body').animate({ scrollTop: $('#getContent').offset().top }, 500);
	toastr.info('Пытаемся отследить посылку...');

    $.ajaxSetup({ cache: false }); // кэш рандом
