...
//update display of the large image - сюда задержку
function displayImage(domAAroundImgThumb)
{
    if (domAAroundImgThumb.attr('href'))
    {
		...
		{ 
            $('#bigpic').fadeOut(50, function(){
                $(this).attr('src', newSrc).show();
                if (typeof(jqZoomEnabled) != 'undefined' && jqZoomEnabled)
	                $(this).attr('alt', domAAroundImgThumb.attr('href'));
            });
            $('#bigpic').fadeIn(50, function(){
                $(this).attr('src', newSrc).show();
                if (typeof(jqZoomEnabled) != 'undefined' && jqZoomEnabled)
	                $(this).attr('alt', domAAroundImgThumb.attr('href'));
            });
...
function showtabs(idtab)
	{
		$("div[id*=idTab]").hide();
		$("div#"+idtab).show();

        $("a[id*=idTab]").removeClass("selected");
        $("a#"+idtab).addClass("selected");
	}
