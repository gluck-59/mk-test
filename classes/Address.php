...
class		Address extends ObjectModel
{
	...
	protected	$fieldsSize = array('alias' => 32, 'company' => 128, 'lastname' => 32, 'firstname' => 32,
									'address1' => 128, 'address2' => 128, 'postcode' => 12, 'city' => 128,
									'other' => 300, 'phone_mobile' => 16);
	protected	$fieldsValidate = array('id_customer' => 'isNullOrUnsignedId', 'id_manufacturer' => 'isNullOrUnsignedId',
                                        ...
                                        'phone' => 'isInn', 'phone_mobile' => 'isPhoneNumber', 'deleted' => 'isBool');
	...
	public	function __construct($id_address = NULL, $id_lang = NULL)
	{
		...
		if ($this->id)
		{
			...
			$cc	= Db::getInstance()->getRow('SELECT  `iso_code` FROM  `presta_country` WHERE  `id_country` ='.intval($this->id_country)); 
			$this->country = $result['name'];
			$this->iso_country = $cc['iso_code'];
		}
	}
