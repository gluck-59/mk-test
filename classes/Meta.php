...
class		Meta extends ObjectModel
{
	...
	static public function getPages($excludeFilled = false, $addPage = false)
	{
		...
		$exludePages = array(
		'cart', 'admin', 'attachment', 'cms', 'discount', 'identity', 'search',	'get-file', 'order-slip', 'order-detail', 'order-follow', 'order-return', 'pagination', 'pdf-invoice', 'pdf-order-return', 'pdf-order-slip', 'product-sort', 'statistics', 'zoom', 'images.inc', 'header', 'footer', 'init',	'product', '0', '1', 'start', 'ym');
