        ...
        if (mysqli_num_rows($res)>0) {
            while ($products=mysqli_fetch_array($res)) {
                ...
                <tr>
                    ...
                    <td width="10%"><div align="center"><a href="order_edit.php?action=add_product&id_lang=<?php echo $products['id_lang'] ?>&id_order=<?php echo $_POST['id_order'] ?>&id_product=<?php echo $products['id_product'] ?>">????????</a></div></td>
                </tr>
